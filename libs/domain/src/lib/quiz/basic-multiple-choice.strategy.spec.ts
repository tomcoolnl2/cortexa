...
describe('BasicMultipleChoiceStrategy', () => {
  ...
  const cards: Card[] = [
    { id: '1', term: 'Closure', definition: 'A function with access to outer scope', deckId: 'd1' },
    { id: '2', term: 'Hoisting', definition: 'Moving declarations to top', deckId: 'd1' },
    { id: '3', term: 'Promise', definition: 'Async operation result', deckId: 'd1' },
    { id: '4', term: 'Prototype', definition: 'Object inheritance mechanism', deckId: 'd1' },
    { id: '5', term: 'Event Loop', definition: 'Async callback handler', deckId: 'd1' },
  ];
